...
\item Wyróżnia się zebranie sprawozdawczo-wyborcze, na którym dokonuje się wybór nowego Przestawiciela oraz przstawia się sprawozdanie finansowe i merytoryczne.
 \end{enumerate}
\end{para}
...
\begin{para}
 \begin{enumerate} 
  ...
  \item Uchwała o rozwiązaniu stowarzyszenia, zmiana Regulaminu Stowarzyszenia oraz decyzja o wyborze lub odwołaniu Przestawiciela podejmowana jest przez bezwzględną większość głosów. 
  \item Członkowie uprawnieni do głosowania muszą zostać powiadomieni najpóźniej 7 dni przed planowanym głosowaniem. Muszą zostać przestawione dwa terminy odległe od siebie co najmniej 30 minut i co najwyżej 2 dni. Zawiadomienie może być za pomocą e-maila, telefonicznie lub listem poleconym.
...
\begin{para}
 \begin{enumerate}
  ...
  \item Przestawiciel jest zobowiązany na zwołanie zebrania sprawozdawczo-wyborcze przed końcem swojej kadencji, na którym zostanie wyłoniony nowy przewodniczący.
 \end{enumerate}
\end{para}
