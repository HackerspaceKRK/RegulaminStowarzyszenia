...
\begin{para}
 ...
 \item Do wyłącznych kompetencji Zebrania Członków należą w szczególności:
  \begin{enumerate}
   ...
   \item rozpatrywanie odowłań od wykluczenia ze Stowarzyszenia
  \end{enumerate}
 \end{enumerate}
\end{para}
...
\begin{para}
 \begin{enumerate}
  ...
  \item Przedstawiciel jest zobowiązany do zwołania zebrania sprawozdawczo-wyborczego, na którym ma zostać wyłoniony nowy przewodniczący, przed końcem swojej kadencji.
 \end{enumerate}
\end{para}
...
\begin{para}
 \begin{enumerate}
  \item Stowarzyszenie ulega rozwiązaniu na podstawie uchwały Zgromadzenia Członków o roziwązaniu Stowarzyszania.
