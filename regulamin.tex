...
\item pomoc w pozyskiwaniu sprzętu, narzędzi, materiałów dla Fundacji.
 \end{enumerate}
\end{para}
...
\begin{para}
 \begin{enumerate} 
  ...
  \item Uchwała o rozwiązaniu stowarzyszenia, zmiana Regulaminu Stowarzyszenia oraz decyzja o wyborze lub odwołaniu Przedstawiciela podejmowana jest bezwzględną większością głosów uprawnionych do głosowania członków. Nieobecność członka jest równoważna z wstrzymaniem się od głosu.
  \item Uprawnieni do głosowania są wszyscy członkowie stowarzyszenia.
\end{enumerate}
\end{para}
\begin{para}
  \begin{enumerate}
  ...
  \item Możliwe drogi powiadomienia to: email, telefon lub list polecony.
 \end{enumerate}
\end{para}
...
\begin{para}
 \begin{enumerate}
  ...
  \item Członkostwo zostaje automatycznie zawieszone w przypadku braku opłaty członkowskiej oraj automatycznie odwieszone po jej dokonaniu.
 \end{enumerate}
\end{para}
...
\begin{para}
 \begin{enumerate}
  ...
  \item Stowarzyszenie rozwązuje się na skutek likwidacji.
 \end{enumerate}
\end{para}
